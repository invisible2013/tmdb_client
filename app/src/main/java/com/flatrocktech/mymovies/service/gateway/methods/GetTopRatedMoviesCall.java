...
public class GetTopRatedMoviesCall extends AbstractAPICall<FilteredMovieResponse> implements MovieProvider {

    @Override
    protected Call<FilteredMovieResponse> buildCaller(ApiInterface apiInterface) {
        return apiInterface.getTopRatedMovies(BuildConfig.TMDB_KEY);
    }
